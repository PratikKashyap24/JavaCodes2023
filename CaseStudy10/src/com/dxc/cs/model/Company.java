 ...
 * @Table(name = "company")
 * 
 * @Component public class Company implements Serializable {
 * 
 * @Id
 * 
 * @Column(name = "compId") private Integer compId;
 * 
 * @Column(name = "compName", nullable = false) private String compName;
 * 
 * public Company() { // left unimplemented }
 * 
 * public Company(Integer compId, String compName) { super(); this.compId =
 * compId; this.compName = compName; }
 * 
